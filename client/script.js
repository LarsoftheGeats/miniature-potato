...
const repeatMyParam = () => {
    //YOUR CODE HERE
    const repeat = document.querySelector('#repeat-text');
    axios.get(`http://localhost:3000/repeat/Jon` ).then((response) => {
...
function getRequest(){
    queryTest=["animals", "dog's", "cats"];
    axios.get('http://localhost:3000/query-test?name=amy&name=jon&name =hello').then((res) => {
